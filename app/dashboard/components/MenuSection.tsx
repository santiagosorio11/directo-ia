  ...
  return (
    <div className="flex flex-col gap-8 max-w-6xl">
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 bg-[#FF5200] hover:bg-[#ff6a2b] transition-all px-6 py-3 rounded-full text-sm font-bold text-white shadow-xl shadow-[#FF5200]/20">
      ...
      {menu.length === 0 ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {menu.map((item) => (
            <div key={item.id} className="bg-[#18181B] border border-white/5 rounded-3xl overflow-hidden group hover:border-[#FF5200]/30 transition-all flex flex-col">
              <div className="h-40 bg-black relative flex flex-col items-center justify-center group-hover:bg-white/5 transition-colors">
                ...
                <div className="absolute top-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button className="w-8 h-8 bg-black/60 backdrop-blur rounded-full flex items-center justify-center hover:bg-[#FF5200] transition-colors">
              ...
              <div className="p-5 flex-1 flex flex-col">
                <div className="flex justify-between items-start gap-2 mb-2">
                  ...
                  <div className="text-[#FF5200] font-black">${item.price.toLocaleString()}</div>
                </div>
