  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30 overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 px-6 md:px-12 lg:px-20 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[500px] bg-gradient-to-b from-primary/10 to-transparent blur-3xl -z-10 opacity-50" />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="flex flex-col gap-6 text-center lg:text-left items-center lg:items-start mt-8 lg:mt-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Link 
                href="/onboarding" 
                className="group px-6 md:px-8 py-4 bg-primary text-white rounded-full font-extrabold text-base md:text-lg shadow-2xl shadow-primary/20 flex items-center justify-center gap-2 active:scale-95 transition-all w-full sm:w-auto"
              >
                Inicia tu demo <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
              <a 
                href="#flujo"
                className="px-6 md:px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full font-bold text-base md:text-lg flex items-center justify-center transition-all w-full sm:w-auto"
              >
                Ver cómo funciona
              </a>
            </div>

            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-8 pt-8 border-t border-white/10 w-full">
      ...
      <section id="problema" className="py-24 px-8 md:px-12 lg:px-20 border-t border-white/5">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-white/5 rounded-3xl p-8 border border-white/10">
            ...
            <div className="text-6xl font-heading font-black text-[primary] mb-4">30%</div>
          ...
          <div className="grid md:grid-cols-4 gap-6 relative">
            ...
            {[
               ...
               <div key={s.n} className="relative z-10 flex flex-col items-center text-center">
                  <div className="w-24 h-24 rounded-full bg-[#09090B] border-8 border-white/5 flex items-center justify-center text-3xl font-heading font-black text-[primary] mb-6">{s.n}</div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div className="bg-[#18181B] rounded-[40px] p-10 border border-white/10 shadow-2xl">
            ...
            <div className="space-y-4 font-mono text-sm sm:text-base">
               ...
               <div className="border-t border-white/10 mt-4 pt-4 flex justify-between items-center text-[primary] font-black text-xl"><span>Pérdida al mes</span><span>$7.200.000</span></div>
            </div>
          </div>
          <div>
            <div className="inline-flex items-center gap-2 mb-6">
            ...
            <div className="space-y-3">
               {[
                 ...
                 <div key={i} className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl">
                   ...
                   <ArrowRight className="w-4 h-4 text-[primary] mx-2 flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="p-10 bg-white/[0.02] border border-white/10 rounded-[40px] flex flex-col">
              ...
              <Link href="/onboarding" className="w-full py-4 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-center font-bold transition-all">Inicia tu demo</Link>
            </div>

            {/* Pro Plan */}
            <div className="p-10 bg-[primary]/10 border-2 border-[primary] rounded-[40px] flex flex-col relative shadow-2xl shadow-[primary]/10">
              <div className="absolute top-0 right-[40px] bg-[primary] text-white px-4 py-1 rounded-b-lg text-xs font-bold uppercase tracking-widest">Popular</div>
              <span className="text-sm font-bold text-[primary] uppercase tracking-widest mb-4">Pro</span>
              <div className="flex items-baseline gap-2 mb-6"><span className="text-5xl font-black font-heading text-white">USD 129</span><span className="text-[primary] font-bold uppercase text-xs">/ Mes</span></div>
              ...
              <Link href="/onboarding" className="w-full py-4 rounded-full bg-[primary] text-white text-center font-extrabold shadow-xl hover:scale-105 active:scale-95 transition-all">Inicia tu demo</Link>
            </div>
      ...
      <section id="cta" className="py-32 px-8 md:px-12 lg:px-20 border-t border-white/5 text-center relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-[primary]/20 blur-[120px] -z-10 opacity-40" />
        <div className="max-w-3xl mx-auto flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center px-4 sm:px-0">
             <Link 
               href="/onboarding" 
               className="group px-8 sm:px-10 py-4 sm:py-5 bg-[primary] text-white rounded-full font-extrabold text-lg sm:text-xl shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-3 w-full sm:w-auto"
             >
               Inicia tu demo
               <ArrowRight className="w-6 h-6 group-hover:translate-x-1 transition-transform" />
             </Link>
             <a href="mailto:ventas@iaorbita.com" className="px-8 sm:px-10 py-4 sm:py-5 bg-white/10 hover:bg-white/15 text-white rounded-full font-bold text-lg sm:text-xl transition-all flex items-center justify-center w-full sm:w-auto">
                Agendar demo
             </a>
          </div>
          <p className="text-primary font-bold text-sm uppercase tracking-widest mt-4 animate-pulse">Se están activando restaurantes de forma controlada</p>
        </div>
      </section>
